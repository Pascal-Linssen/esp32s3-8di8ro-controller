...
```
1. Lire: SOLUTION_SUMMARY.md (diagrammes)
2. Lire: README_MQTT_SOLUTION.md (contexte)
...
```
1. Installer: test_mqtt_fixed.py
2. Faire: pio run && pio run --target upload
3. Exécuter: python3 test_mqtt_fixed.py
...
- **Commande** : `python3 test_mqtt_fixed.py`
