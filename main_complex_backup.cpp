...
// Pins I2C pour TCA9554 (désactivé temporairement pour test)
...
void setup() {
  ...
  // Initialisation I2C avec pins spécifiques Waveshare (temporairement désactivé)
  // Wire.begin(I2C_SDA_PIN, I2C_SCL_PIN);
  // Serial.printf("✓ I2C initialisé (SDA=%d, SCL=%d)\n", I2C_SDA_PIN, I2C_SCL_PIN);
  Serial.println("⚠️ I2C désactivé temporairement pour tests");
  
  // Initialisation TCA9554 (temporairement désactivé)
  // tca9554_init();
  // Serial.println("✓ TCA9554 initialisé (relais)");
  Serial.println("⚠️ TCA9554 désactivé temporairement");
